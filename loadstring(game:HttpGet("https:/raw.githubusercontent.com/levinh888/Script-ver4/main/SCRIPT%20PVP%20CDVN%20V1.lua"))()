...
--đánh nhanh
local đánh nhanh = false
local đánh nhanhBtn =
Instance.new("TextButton", pvpTab)
đánh nhanhBtn.Text = "đánh nhanh: 0FF
đánh nhanhBtn.Size = UDim2.new(0, 200, 0, 30)
đánh nhanhBtn.Position = UDim2.new(0, 10, 0, 50)
đánh nhanhBtn.MouseButton1Click:Connect(function()
     đánh nhanh = not đánh nhanh
     đánh nhanhBtn.Text = đánh nhanh and
"Đánh nhanh: ON" or "Đánh nhanh: OFF"
end)
